...
ShellRoot {
    ...
    Variants {
        ...
        PanelWindow {
            ...
            // ── Vidéo reveal (disabled - video not available) ──
            /*
            MediaPlayer {
                id: reveal
            ...
            */
            ...
            // ── Vidéo hide (disabled - video not available) ──
            /*
            MediaPlayer {
                id: hide
            ...
            */
            ...
            Timer {
                ...
                onTriggered: { root.done=true; exitTimer.restart() }
            }
            ...
            Connections {
                ...
                function onRevealingChanged() {
                    if (root.revealing) {
                        root.frozen = true
                        // Video reveal disabled - skip animation
                        panelOpenTimer.restart()
                    }
                }
                function onHidingChanged() {
                    if (root.hiding) {
                        // Video hide disabled - skip animation
